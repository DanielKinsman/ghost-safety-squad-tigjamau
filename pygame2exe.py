# shamelessly stolen from http://www.pygame.org/wiki/Pygame2exe -dan
...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "GhostSafetySquad"
 
        #Project url
        self.project_url = "http://github.com/DanielKinsman/ghost-safety-squad-tigjamau"
 
        #Version of program
        self.project_version = "0.0"
 
        #License of the program
        self.license = "GNU General Public License 3"
 
        #Auhor of program
        self.author_name = "Daniel Kinsman"
        self.author_email = "danielkinsman+gss@gmail.com"
        self.copyright = "Copyright (c) 2012 Daniel Kinsman, Natasha de Bakker and Rebecca Knight."
 
        #Description
        self.project_description = "A video game"
